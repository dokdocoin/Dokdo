...
const QString BITCOIN_IPC_PREFIX("Dokdo:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Dokdo: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Dokdo: click-to-pay handler");
    else
...
{
    // clicking on Dokdo: URLs creates FileOpen events on the Mac:
