...
//---genesis blocks -------------------------------------------------------------------------------------
uint256 hashGenesisBlock("0x000007bc31daa3a112bb2dd6b51a716a7586571e5dabc2aa931a2e07f9cd605f");
uint256 hashGenesisBlockTestNet("0x000001124455461e0958d5f91fbada6e6cdf25a74b1628bde2fcc0070a0198d6");
//-------------------------------------------------------------------------------------------------------
uint256 MainHashMerkleRoot("0x2d411aec66753b428ff52cd0f80c865b8ca0076528677188989d81160ae3e4fd");
//--time blocks ---------------------------------------
static const unsigned int timeGenesisBlock =1400925600;
static const unsigned int timeGenesisBlockTestNet =1400411925;
//-------nNonce -------------------------------------
static const unsigned int nNonceGenesis=705755;
static const unsigned int nNonceGenesisTestNet=2220886;
//----------------------------------------------------
...
const string strMessageMagic = "Dokdo Signed Message:\n";
...
static const int64 nPremine = 3780000 * COIN;
...
int64 static GetBlockSubsidy(int nHeight){
	...
	if (nHeight == 1)
    {
        return nPremine;
		/*
		20% pre-mine for old DDC users	=3780000
		*/
    }
    
	int64 nSubsidy = 45 * COIN;
    
    // Subsidy is reduced by 3% every 10080 blocks, which will occur approximately every 1 week
...
static const int64 nTargetSpacing = 1 * 60; // Dokdo every 60 seconds
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
        ...
        // Prevent blocks from too far in the future [since Dokdo version 2.0 at block 100,000]
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Dokdo is a new version of Dokdocoin. It was launched on 24th May";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DokdoMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DokdoMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DokdoMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Dokdo-miner");
    ...
    try { loop {
        ...
        printf("Running DokdoMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
